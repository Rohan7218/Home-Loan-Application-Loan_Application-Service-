...
public class ApplicantDetailsController 
{
	...
	@PatchMapping(value = "/applicants/{applicantId}")
	public ResponseEntity<ApiResponse<String>>updateApplicantStatus(@RequestBody AccountStatusDTO accountStatusDTO, @PathVariable Integer applicantId)
	{	
		String msg =applicantDetailsService.updateApplicantStatus(accountStatusDTO , applicantId);
		ApiResponse<String> apiResponse=new ApiResponse<String>(msg);
